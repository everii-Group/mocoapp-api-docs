...
{: .note }
This documentation is outdated, please refer to [our OpenAPI spec](https://docs.mocoapp.com/api/docs/v1#tag/purchases).
  ...
  "items": [
    {
      ...
      "tax_total": 1.12,
      "tax": 2.5,
      "vat": { "tax": 2.5, "reverse_charge": false, "intra_eu": false, "active": true, "code": "9" },
      "tax_included": true,
      "gross_total": 46.0,
      "category": {
        "id": 671034328,
